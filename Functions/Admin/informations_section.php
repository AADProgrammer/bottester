<?php
    include "../../config.php";
    $SECTION = "informations_section";
    $part_menu = "قسم المعلومات";
    ...
    function showinformationsAccounts($folder){
    ...
    function setMenu($menu_section, $menu_num){
        ...
        if($menu_section == $SECTION){
            ...
            if($menu_num == 0){
                $informations_section_file = $section_data_folder . "informations.json";
                if(!file_exists($informations_section_file)) file_put_contents($informations_section_file, "{}");
                $array_data = json_decode(file_get_contents($informations_section_file), true);
            ...
            if($menu_num == 2){
                ...
                $informations_section_file = $section_data_folder . "informations.json";
                if(!file_exists($informations_section_file)) file_put_contents($informations_section_file, "{}");
                $array = json_decode(file_get_contents($informations_section_file), true);
            ...
            if($menu_num == 5){
                showinformationsAccounts($shared_preferences['id']);
                return false;
            }
            ...
            if($text){
                ...
                if($menu_num == 1){
                    if($text == BACK_TEXT){
                        ...
                        saveFileWithEncodeArray($informations_section_file, $array);
                        bot('sendMessage',[
                            'chat_id'=>$chat_id,
