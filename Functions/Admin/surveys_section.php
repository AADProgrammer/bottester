<?php
    ...
    function showSurveysAccounts($folder){
    ...
    function sendForAdmins($type, $count){
        ...
        $isText = true;
        $text = "تم إضافة حسابات جديدة بنجاح ✅" . EQUALS . "عدد الحسابات المضافة : " . $count . NEW_LINE . "القسم : " . "استبيانات" . NEW_LINE . "المنتج : ". $shared_preferences['name'] . NEW_LINE . "راس المال : " . $shared_preferences['purchase_price'] . NEW_LINE . "اسم الادمن : " . $first_name . NEW_LINE . "ايدي الادمن : " . $chat_id;
    ...
    function setMenu($menu_section, $menu_num){
        ...
        if($menu_section == $SECTION){
            if($menu_num == 0){
                $surveys_section_file = $section_data_folder . "surveys.json";
            ...
            if($menu_num == 2){
                ...
                $surveys_section_file = $section_data_folder . "surveys.json";
                if(!file_exists($surveys_section_file)) file_put_contents($surveys_section_file, "{}");
                $array = json_decode(file_get_contents($surveys_section_file), true);
                ...
                bot('sendMessage',[
                    ...
                    'reply_markup'=>json_encode([
                        ...
                        'keyboard'=>[
                            ...
                            [['text'=>"تفاصيل قبل الشراء", "callback_data"=>""]],
            ...
            if($menu_num == 5){
                showSurveysAccounts($shared_preferences['id']);
                return false;
            }
            ...
            if($menu_num == 10){
                bot('sendMessage',[
                    'chat_id'=>$chat_id,
                    'text'=>"الرسالة الحالية : " . NEW_LINE . $shared_preferences['details'] . EQUALS ."قم بإرسال رسالة التفاصيل الذي سيتم عرضها للمستخدم قبل تاكيد شراء الحساب",
                    'reply_markup'=>json_encode([
                        'resize_keyboard'=>true,
                        'keyboard'=>[
                            [['text'=>BACK_TEXT, "callback_data"=>BACK_TEXT]],
            ...
            if($text){
                ...
                if($menu_num == 1){
                    if($text == BACK_TEXT){
                        ...
                        saveFileWithEncodeArray($surveys_section_file, $array);
                        bot('sendMessage',[
                            'chat_id'=>$chat_id,
                ...
                if($menu_num == 2){
                    ...
                    if($text == "تفاصيل قبل الشراء"){
                        setMenu($menu_section, 10);
                        return false;
                    }
        ...
        if($data){
            if($menu_num == 5){
                ...
                bot('editMessageText',[
                    ...
                    'chat_id'=>$chat_id,
                    'text'=>'رقم المنتج : 1' . NEW_LINE . "القسم : استبيانات" . NEW_LINE . "المنتج : " . $file_data['section_name'] . NEW_LINE . "اسم الادمن : " . $file_data['admin_name'] . NEW_LINE . "ايدي الادمن : " . $file_data['admin_id'] . NEW_LINE . "رأس المال : " . $file_data['purchase_price'] . NEW_LINE . "رقم الطلب : " . $file_data['order_name'] . EQUALS . $file_data['account'],
                    'reply_markup'=>json_encode([
                        'resize_keyboard'=>true,
                        'inline_keyboard'=>[
